...
public class RegisterCloudName extends RegisterCloud {
    ...
    public void register(String env, String cspName, String cspPassword,
        ...
        try {
            ...
            try {
                services.put(
                        ...
                        "https://respectconnect.neustar.biz/"
                                + URLEncoder.encode(cloudNumber.toString(),
                                        "UTF-8") + "/connect/request");
             ...
             * 
             * if (!cloudNameAvailable) throw new RuntimeException("Cloud Name "
             * + cloudName + " is not available.");
             */

            // Step 4: Check if the phone number and e-mail address are
            // available

            CloudNumber[] existingCloudNumbers = csp
                    .checkPhoneAndEmailAvailableInRN(verifiedPhone,
                            verifiedEmail);
            ...
            csp.setPhoneAndEmailInCloud(cloudNumber, secretToken,
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (str != null
            ...
            regMachine.register(env, cspName, cspPassword, cloudNameString,
                    cloudNumberString, cloudPass, verifiedPhone, verifiedEmail);
