...
public class RegisterDependentCloud extends RegisterCloud {
        ...
        for (int tries = 0; tries < 10; tries++) {
            ...
            try {
                ...
                XDIDiscoveryResult guardianRegistry = discovery
                        .discoverFromRegistry(XDI3Segment
                ...
                String guardianXdiEndpoint = guardianRegistry
                        .getXdiEndpointUri();
                String dependentXdiEndpoint = dependentRegistry
                        .getXdiEndpointUri();
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (str != null
            ...
            RegisterCloud registerCloud = new RegisterCloudName();
